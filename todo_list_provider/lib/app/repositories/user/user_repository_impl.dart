...
class UserRepositoryImpl implements UserRepository {
    ...
    try {
      ...
      if (googleUser != null) {
        ...
        if (loginMethods.contains('password')) {
          throw AuthException(
              message:
                  'Você utilizou o e-mail para cadastro no TodoList, caso tenha esquecido sua senha por click no link esqueci minha senha');
        } else {
  ...
  @override
  Future<void> updateDisplayNamed(String name) async {
